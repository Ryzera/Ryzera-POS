...
export function ProfitLossFilters({
  ...
  const [dateFrom, setDateFrom] = useState<Date>(() =>
    paramDateFrom ? new Date(paramDateFrom) : new Date(PL_DEFAULT_DATE_FROM),
  );
  const [dateTo, setDateTo] = useState<Date>(() =>
    paramDateTo ? new Date(paramDateTo) : new Date(PL_DEFAULT_DATE_TO),
  );

  // Auto-generate if loaded from Saved Configs
  useEffect(() => {
