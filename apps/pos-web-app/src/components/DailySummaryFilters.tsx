...
export function DailySummaryFilters({ onGenerate, isLoading }: DailySummaryFiltersProps) {
    const [selectedDate, setSelectedDate] = useState<Date>(new Date(DEFAULT_SUMMARY_DATE));
            ...
            <div className="flex flex-col gap-1">
                ...
                <Popover>
                    <PopoverTrigger asChild>
                        <Button
                            variant="outline"
                            className={cn(triggerClass, 'w-52')}
                        >
