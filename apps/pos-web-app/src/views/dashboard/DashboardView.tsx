...
import {
    ...
    TriangleAlert, ChevronDown, Bell,
} from 'lucide-react';
...
// Temporary constant — replace with settings API once KPI Settings page is built
...
export function DashboardView() {
    ...
    const effectiveBranchId = useMemo((): number | undefined => {
        if (!isSuperAdmin) return user?.branchId ?? undefined;
        return selectedBranchId ? Number(selectedBranchId) : undefined;
    }, [isSuperAdmin, user?.branchId, selectedBranchId]);
    ...
    return (
        <div className="min-h-screen bg-[#f1f5f9] flex flex-col">
            ...
            <div className="flex-1 px-8 py-6 space-y-5 overflow-y-auto">
                ...
                {/* Sales Target Bar */}
                <SalesTargetBar
                    currentRevenue={liveSales.data?.totalSalesThisMonth ?? 0}
