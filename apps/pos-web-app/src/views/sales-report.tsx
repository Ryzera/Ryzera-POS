...
function SalesBarChart({
  ...
  const rawData = Array.isArray(chartResp?.data)
    ? chartResp.data
    : Array.isArray((chartResp as any)?.data?.data)
      ? (chartResp as any).data.data
      : Array.isArray(chartResp)
        ? chartResp
        : [];
  ...
  const needsScroll = formatted.length > 12;
  const minWidth = needsScroll ? `${formatted.length * 52}px` : '100%';
      ...
      <div style={{ width: minWidth, minWidth: '100%', height: chartHeight }}>
        <ResponsiveContainer width="100%" height="100%">
          <BarChart
            ...
            barCategoryGap={formatted.length <= 4 ? "40%" : "20%"}
          >
            <CartesianGrid
              strokeDasharray="3 3"
              stroke="#f1f5f9"
...
export default function SalesReportPage() {
  ...
  // ── Build queryParams from filters + selectedBranchId together ─────────────
  ...
  const isPerBranchEnabled = generated && !!queryParams && activeTab === 'per-branch' && isAdmin;
  ...
  return (
    <div className="min-h-screen bg-[#f1f5f9] flex flex-col">
      ...
      >
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            ...
            {/* Branch Manager — static branch name pill */}
      ...
      <div className="flex-1 px-8 py-6 space-y-5 overflow-y-auto">
        ...
        {isAdmin && generated && selectedBranchId === "" && (
          <div
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  ...
                  {chartResp && (
                    <span
                      className="text-[11px] text-gray-400 bg-gray-100
                ...
                {chartLoading ? (
                  ...
                  <SalesBarChart
                    chartResp={chartResp as SalesChartResponse | undefined}
                  />
                )}
              </div>
