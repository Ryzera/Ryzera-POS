...
export const fetchInventoryStatus = async (params: InventoryStatusQueryParams): Promise<InventoryStatusResponse> => {
  const res = await api.get('/inventory-status/cards', { params: toBackendParams(params) });
  return res.data.data;
};

// ─── Per-Branch View ──────────────────────────────────────────

export const fetchInventoryByBranch = async (params: InventoryStatusQueryParams): Promise<InventoryByBranchResponse> => {
  const res = await api.get('/inventory-status/by-branch', { params: toBackendParams(params) });
  return res.data.data;
};
...
export const exportInventoryCSV = async (
    ...
    const { data } = await api.get<Blob>('/inventory-status/export/csv', {
...
export const exportInventoryPDF = async (
    ...
    const { data } = await api.get<Blob>('/inventory-status/export/pdf', {
        params:       toBackendParams(params),
        responseType: 'blob',
    });
    return data;
...
export const exportInventoryBranchCSV = async (
    ...
    const { data } = await api.get<Blob>('/inventory-status/export/branch/csv', {
...
export const exportInventoryBranchPDF = async (
    ...
    const { data } = await api.get<Blob>('/inventory-status/export/branch/pdf', {
        params:       toBranchExportParams(params),
        responseType: 'blob',
    });
    return data;
