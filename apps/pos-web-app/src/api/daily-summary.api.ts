...
export const fetchDailySummaryCards = async (
  ...
  const res = await api.get("/daily-summary/cards", {
...
export const fetchHourlySales = async (
  ...
  const res = await api.get("/daily-summary/hourly-chart", {
    params: toBackendParams(params),
  });
  return res.data.data;
};
...
export const fetchDailyPaymentMethods = async (
  ...
  const res = await api.get("/daily-summary/payment-methods", {
    params: toBackendParams(params),
  });
  return res.data.data;
};
...
export const fetchDailySummaryDetails = async (
  ...
  const res = await api.get("/daily-summary/details", {
    params: toBackendParams(params),
  });
  return res.data.data;
};
...
export const fetchAllBranchesSummary = async (
  ...
  const res = await api.get("/daily-summary/all-branches", {
    params: toBackendParams(params),
  });
  return res.data.data;
};
...
export const exportDailySummaryCSV = async (
    ...
    const { data } = await api.get<Blob>('/daily-summary/export/csv', {
        params:       toBackendParams(params),
        responseType: 'blob',
    });
    return data;
...
export const exportDailySummaryPDF = async (
    ...
    const { data } = await api.get<Blob>('/daily-summary/export/pdf', {
        params:       toBackendParams(params),
        responseType: 'blob',
    });
    return data;
