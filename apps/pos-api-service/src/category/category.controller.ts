...
export class CategoryController {
  ...
  findAll(@Query(new ZodValidationPipe(CategoryListQuerySchema)) query: CategoryListQueryDto) {
  ...
  @ApiResponse({ status: 200, description: 'Category detail with active products' })
